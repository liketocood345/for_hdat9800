---
title: "Fusing Four Plotting Skills into One ggplot Hourglass"
description: |
...
| Artifact | Role |
|----------|------|
| `ggplot-hourglass/SKILL.md` | Thin fused entry—one funnel, not four parallel loads |
| `hourglass-skill-merge/SKILL.md` | Meta skill—hourglass merge for any conflicting set |
